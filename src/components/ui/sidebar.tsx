        ...
        <div
          className={cn(
            ...
            variant === "floating" || variant === "inset"
              ...
              : "group-data-[collapsible=icon]:w-[--sidebar-width-icon] group-data-[side=left]:border-r group-data-[side=right]:border-l group-data-[state=collapsed]:border-r-0 group-data-[state=collapsed]:border-l-0",
            className
          )}
          {...props}
        >
